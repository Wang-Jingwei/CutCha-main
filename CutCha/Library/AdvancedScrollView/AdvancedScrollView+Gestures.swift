...
@available(macOS 10.15, iOS 13.0, *)
public typealias LongPressContentAction = (_ location: CGPoint, _ proxy: AdvancedScrollViewProxy) -> Void
...
public extension AdvancedScrollView {
    ...
    func onLongPressContentGesture(perform action: @escaping LongPressContentAction) -> AdvancedScrollView {
        let longPressContentGestureInfo = LongPressContentGestureInfo(action: action)
        return AdvancedScrollView(magnification: magnification,
                                  isScrollIndicatorVisible: isScrollIndicatorVisible,
                                  tapContentGestureInfo: tapContentGestureInfo,
                                  dragContentGestureInfo: dragContentGestureInfo,
