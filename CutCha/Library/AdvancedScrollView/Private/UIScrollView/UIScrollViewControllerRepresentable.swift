...
struct UIScrollViewControllerRepresentable<Content: View>: UIViewControllerRepresentable {
    ...
    let longPressContentGestureInfo : LongPressContentGestureInfo?
    ...
    init(magnification: Magnification,
         ...
         longPressContentGestureInfo : LongPressContentGestureInfo?,
        ...
        self.longPressContentGestureInfo = longPressContentGestureInfo
    ...
    func updateUIViewController(_ uiViewController: UIScrollViewController, context: Context) {
        ...
        if uiViewController.contentViewController == nil {
            ...
            if let longPressContentGestureInfo = longPressContentGestureInfo {
                uiViewController.onLongPressGesture { location in
                    longPressContentGestureInfo.action(location, proxy)
                }
            }
        } else {
