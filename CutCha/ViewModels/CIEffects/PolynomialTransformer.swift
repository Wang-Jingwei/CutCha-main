...
class PolynomialTransformer: ObservableObject, FilterModel {
    ...
    init(photoManager : PhotoManager) {
        ...
        self.photoManager.polynomialTransformer = self
        setup()
    }
