...
//  SegmentAnywhere
//
//  Created by hansoong choong on 4/3/24.
//
...
public final class ImageCache: ImageCacheType {
    ...
    func generateRandomURLWithLength(length:Int, suffix : String = "") -> URL {
        let randomStr = generateRandomStringWithLength(length: length)
        return URL(fileURLWithPath: "/Users/hansoong/\(randomStr)\(suffix)")
    }
}
