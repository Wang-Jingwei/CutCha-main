...
struct EightfoldReflectedTileView: View {
    ...
    func valueChanged() {
        let effect: CIFilterEffect = .eightfoldReflectedTile(width: width, angle: rotation, position: xyRatio[0])
