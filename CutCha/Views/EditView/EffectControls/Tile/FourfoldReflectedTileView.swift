//
//  FourfoldReflectedTileView.swift
//  CutCha
//
...
struct FourfoldReflectedTileView: View {
    ...
    func valueChanged() {
        let effect: CIFilterEffect = .fourfoldReflectedTile(width: width, angle: rotation, position: xyRatio[0])
