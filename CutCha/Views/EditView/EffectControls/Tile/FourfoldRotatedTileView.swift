...
struct FourfoldRotatedTileView: View {
    ...
    func valueChanged() {
        let effect: CIFilterEffect = .fourfoldRotatedTile(width: width, angle: rotation, position: xyRatio[0])
