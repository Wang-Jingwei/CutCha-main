...
struct GlideReflectedTileView: View {
    ...
    func valueChanged() {
        let effect: CIFilterEffect = .glideReflectedTile(width: width, angle: rotation, position: xyRatio[0])
