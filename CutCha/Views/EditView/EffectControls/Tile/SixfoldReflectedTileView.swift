//
//  SixfoldReflectedTileView.swift
//  CutCha
//
...
struct SixfoldReflectedTileView: View {
    ...
    func valueChanged() {
        let effect: CIFilterEffect = .sixfoldReflectedTile(width: width, angle: rotation, position: xyRatio[0])
