//
//  TwelvefoldReflectedTileView.swift
//  CutCha
//
...
struct TwelvefoldReflectedTileView: View {
    ...
    func valueChanged() {
        let effect: CIFilterEffect = .twelvefoldReflectedTile(width: width, angle: rotation, position: xyRatio[0])
