...
open class CropperViewController: UIViewController, Rotatable, StateRestorable, Flipable {
    ...
    public init(workingImage: UIImage, initialState: CropperState? = nil) {
        self.originalImage = workingImage
    ...
    public override func viewDidAppear(_ animated: Bool) {
        delegate?.cropperSetIntialState(self, state: saveState())
    }
    ...
    let bottomViewHeight: CGFloat = 180
    let customGap: CGFloat = 20
    let angleRulerInset: CGFloat = 50
    let aspectRatioInset: CGFloat = 60
    ...
    open lazy var bottomView: UIView = {
        let view = UIView(frame: CGRect(x: 0, y: 0, width: self.view.width, height: bottomViewHeight))
    ...
    open lazy var toolbar: UIView = {
        ...
        toolbar.flipButton.addTarget(self, action: #selector(flipButtonPressed(_:)), for: .touchUpInside)
        toolbar.rotateButton.addTarget(self, action: #selector(rotateButtonPressed(_:)), for: .touchUpInside)
        
        //Color.check
//        toolbar.resetButton.layer.borderColor = UIColor.red.cgColor
//        toolbar.resetButton.layer.borderWidth = 1
//        toolbar.doneButton.layer.borderColor = UIColor.red.cgColor
//        toolbar.doneButton.layer.borderWidth = 1
//        toolbar.flipButton.layer.borderColor = UIColor.red.cgColor
//        toolbar.flipButton.layer.borderWidth = 1
//        toolbar.rotateButton.layer.borderColor = UIColor.red.cgColor
//        toolbar.rotateButton.layer.borderWidth = 1
    ...
    public lazy var angleRuler: AngleRuler = {
        let ar = AngleRuler(frame: CGRect(x: angleRulerInset, y: 0, width: view.width - angleRulerInset*2, height: barHeight))
    ...
    public lazy var aspectRatioPicker: AspectRatioPicker = {
        let picker = AspectRatioPicker(frame: CGRect(x: aspectRatioInset, y: 0, width: view.width - aspectRatioInset*2, height: barHeight))
...
// MARK: - Private Methods
    ...
    open func resetToDefaultLayout() {
        bottomView.size = CGSize(width: view.width, height: bottomViewHeight)
        bottomView.bottom = view.height
        bottomView.backgroundColor = .black
        
        toolbar.size = CGSize(width: view.width, height: barHeight)
        
        aspectRatioPicker.centerY = 40
        toolbar.bottom = bottomView.height
        angleRuler.bottom = toolbar.top
        let bottomHeight = bottomView.height
        ...
        angleRuler.value = 0
        aspectRatioPicker.aspectRatios = aspectRatios
...
//        toolbar.layer.borderColor = UIColor.green.cgColor
//        aspectRatioPicker.layer.borderColor = UIColor.red.cgColor
//        angleRuler.layer.borderColor = UIColor.orange.cgColor
//        bottomView.layer.borderWidth = 1
//        toolbar.layer.borderWidth = 1
//        aspectRatioPicker.layer.borderWidth = 1
//        angleRuler.layer.borderWidth = 1
    }
